...
const clerkAppearance = {
  ...
  variables: {
    colorPrimary: "hsl(41 54% 46%)",
    colorForeground: "hsl(216 60% 11%)",
    colorMutedForeground: "hsl(216 20% 40%)",
    colorDanger: "hsl(0 84% 60%)",
    colorBackground: "hsl(0 0% 100%)",
    colorInput: "hsl(0 0% 100%)",
    colorInputForeground: "hsl(216 60% 11%)",
  ...
  elements: {
    ...
    logoBox: "h-12 w-12 mb-4 mx-auto",
    ...
    formFieldInput: "border-border bg-white text-foreground focus:ring-ring",
    footerAction: "mt-6",
      ...
      <QueryClientProvider client={queryClient}>
        ...
        <TooltipProvider>
          <Switch>
            ...
            <Route path="/books/:id">
              {(params) => <Layout><BookDetail id={parseInt(params.id)} /></Layout>}
            </Route>
            <Route path="/reader/:id">
              {(params) => <Reader id={parseInt(params.id)} />}
            </Route>
